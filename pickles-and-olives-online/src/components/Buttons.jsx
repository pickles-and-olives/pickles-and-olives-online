  ...
  export function BlueButton({ buttonText, action, disabled }) {
    return (
      <button
        onClick={action}
        disabled={disabled}
        className='p-2 m-1 border-2 whitespace-nowrap rounded-md border-themeBlue text-themeBlue hover:ring-2 ring-themeBlue/50 transition duration-500 ease-in-out'
      >
        {buttonText}
      </button>
    );
